...
USAH_template_baseline %>% saveRDS(filenameTimestamp(
  prefix = "outputs/USAH_template_baseline", extension = ".RDS")) ## Specify filename
...
USAH_template_baseline$vInfo %>% write.csv(filenameTimestamp(
  prefix = "outputs/USAH_template_baseline_vInfo_full", extension = ".csv")) ## Specify filename
...
USAH_template_baseline$results %>% write.csv(filenameTimestamp(
  prefix = "outputs/USAH_template_baseline_results", extension = ".csv")) ## Specify filename
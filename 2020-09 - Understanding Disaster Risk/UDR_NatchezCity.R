...
dat = read.csv(file("NC_Flood_CSV_18_02_2019.csv"), 
...
dat_tnet = read.csv(file("NC_Flood_CSV_18_02_2019.csv"), 
                    header = TRUE, row.names = 1, check.names = FALSE)
...
vertex_W_betweenness_MASTER <- betweenness_w(MASTER_tnet, directed = NULL, alpha = 1)
...
write.csv(MASTER_RESULTS, file = "NC_Flood_RESULTS_18_02_2019.csv")
